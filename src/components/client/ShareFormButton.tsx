...
import { Share2Icon, CheckIcon, CopyIcon, QrCodeIcon } from "lucide-react";
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Compartilhe este formulário com seus clientes para que eles possam se cadastrar diretamente.
          </DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="link" className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
                Envie este link por e-mail, WhatsApp ou qualquer outro meio para que seus clientes possam preencher o formulário.
          ...
          <TabsContent value="qrcode" className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground text-center">
                Seus clientes podem escanear este QR code com a câmera do celular para acessar o formulário de cadastro.
              </p>
            </div>
          </TabsContent>
        </Tabs>
