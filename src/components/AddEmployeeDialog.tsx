      ...
      <DialogContent className="sm:max-w-[500px] bg-card">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 py-4">
          <div className="grid gap-2">
            ...
            <Input id="cnpj" placeholder="00.000.000/0001-00" value={formData.cnpj} onChange={e => setFormData({
            ...formData,
            cnpj: e.target.value
          })} required />
          </div>
          ...
          <div className="grid gap-2">
            ...
            <Input id="pix" placeholder="CPF, CNPJ, E-mail ou Celular" value={formData.pix} onChange={e => setFormData({
            ...formData,
            pix: e.target.value
          })} required />
          </div>
          ...
          <div className="grid gap-2">
            ...
            <Input id="address" placeholder="Rua, número, complemento, bairro, cidade - UF" value={formData.address} onChange={e => setFormData({
            ...formData,
          ...
          <div className="grid gap-2">
            ...
            <Select value={formData.type} onValueChange={(value: "fixed" | "freelancer") => setFormData({
            ...formData,
            type: value
          })}>
