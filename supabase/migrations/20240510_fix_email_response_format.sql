...
-- Fix the check_billing_notifications function to correctly handle the response structure
        ...
        LOOP
            ...
            IF due_date_this_month - interval_record.days_before * INTERVAL '1 day' = current_date_var THEN
                ...
                BEGIN
                    ...
                    -- Fixed by using EXPLICIT columns and dot notation to access response fields
                    ...
                    ) r; -- Use table alias 'r' to ensure clarity
